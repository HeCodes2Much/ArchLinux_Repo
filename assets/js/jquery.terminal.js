    ...
    $.fn.terminal = function(e, t) {
        ...
        function f(e) {
            if ($.terminal.unclosed_strings(e)) {
                ...
                var n = sprintf(ie().invalidStrings, "`" + t + "`");
                throw new $.terminal.Exception(n)
            } else if (is_function(je.processArguments)) {
                return process_command(e, je.processArguments)
            } else if (je.processArguments) {
        ...
        function s(e, t) {
            ...
            if (is_function(je.renderHandler)) {
                var n = je.renderHandler.call(ue, e, t, ue);
                if (n === false) {
                    return false
                }
        ...
        function m(e) {
            ...
            if (typeof e === "string") {
                ...
                ue.echo($.map(e, function(e) {
                    return JSON.stringify(e)
                }).join(" "))
            } else if (typeof e === "object") {
                ue.echo(JSON.stringify(e))
            } else {
                ue.echo(e)
            }
        }
        ...
        function c(e) {
            if (is_function(je.onRPCError)) {
                je.onRPCError.call(ue, e)
            } else {
                ue.error("&#91;RPC&#93; " + e.message);
            ...
            var i = function(e, t) {
                ...
                $.jrpc({
                    ...
                    success: function e(t) {
                        if (t.error) {
                            c(t.error)
                        } else if (is_function(je.processRPCResponse)) {
                            je.processRPCResponse.call(ue, t.result, ue)
        ...
        function d(a, o, s, l) {
            return function(e, t) {
                ...
                try {
                    ...
                    if (is_function(je.exception)) {
                        je.exception(e, ue)
                    } else {
                        ue.error("Error: " + (e.message || e))
                    }
                    return
                }
                var r = a[n.name];
                ...
                if (i === "function") {
                    if (o && r.length !== n.args.length) {
                        ue.error("&#91;Arity&#93; " + sprintf(ie().wrongArity, n.name, r.length, n.args.length))
                    } else {
                        return r.apply(ue, n.args)
                    }
                    ...
                    l(e, ue)
                } else if (is_function(je.onCommandNotFound)) {
                    je.onCommandNotFound.call(ue, e, ue)
                } else {
                    t.error(sprintf(ie().commandNotFound, n.name))
                }
            }
        }
        ...
        function h(e, t, n) {
            ue.resume();
            if (is_function(je.onAjaxError)) {
                je.onAjaxError.call(ue, e, t, n)
            } else if (t !== "abort") {
                ue.error("&#91;AJAX&#93; " + t + " - " + ie().serverResponse + ":\n" + $.terminal.escape_brackets(e.responseText))
            }
        }
        ...
        function v(u, o, r) {
            function s(e) {
                if (e.error) {
                    ...
                    je.processRPCResponse.call(ue, e.result, ue)
                } else {
                    m(e.result)
                }
                ue.resume()
            ...
            function e(e) {
                var n = e;
                if (je.describe !== false && je.describe !== "") {
                    je.describe.split(".").forEach(function(e) {
                        n = n[e]
                    })
                }
                if (n && n.length) {
                    ...
                    $.each(n, function(e, i) {
                        if ($.isPlainObject(i) && typeof i.name === "string") {
                            t[i.name] = function() {
                                ...
                                if (je.checkArity && i.params && i.params.length !== n) {
                                    ue.error("&#91;Arity&#93; " + sprintf(ie().wrongArity, i.name, i.params.length, n))
                                } else {
                                    ue.pause(je.softPause);
                                    if (e) {
                                        var r = ue.token(true);
            ...
            if (e === "array") {
                ...
                (function t(e, n) {
                    if (e.length) {
                        ...
                        if (u === "string") {
                            ue.pause(je.softPause);
                            if (je.describe === false) {
                                if (++s === 1) {
                                    l = p(r, a)
                                } else {
                                    ue.error(ie().oneRPCWithIgnore)
                                }
                                t(i, n)
                            } else {
                                v(r, a, function(e) {
                            ...
                            if (l) {
                                ue.error(ie().oneInterpreterFunction)
                            } else {
                                l = r
                            }
                            t(i, n)
                    ...
                    n({
                        interpreter: d(o, false, a, l && l.bind(ue)),
                ...
                if (je.describe === false) {
                    ...
                    if ($.isArray(je.completion)) {
                        o.completion = je.completion
                    }
                    n(o)
                } else {
                    ue.pause(je.softPause);
                ...
                n({
                    interpreter: d(t, je.checkArity, a),
        ...
        function y(e, t, n) {
            if (is_function(je.exceptionHandler)) {
                je.exceptionHandler.call(ue, e, t)
            } else {
                ue.exception(e, t);
                if (!n) {
                    setTimeout(function() {
        ...
        function C(e, t) {
            return (strlen(text(e)) > t.cols || e.match(/\n/)) && (je.wrap === true && t.wrap === undefined || je.wrap === false && t.wrap === true)
        }
        var F;
        if ("Map" in root) {
            F = new Map
            ...
            if (r.exec || n.options.clear_exec) {
                return $.terminal.each_extended_command(e, function(e) {
                    if (r.exec) {
                        ...
                        if (De && De === t) {
                            De = "";
                            ue.error(ie().recursiveLoop)
                        } else {
                            De = t;
                            $.terminal.extended_command(ue, e, {
        ...
        function E(t) {
            try {
                ...
                if (r !== "") {
                    if (!n.raw) {
                        if (je.useCache && n.useCache) {
                            var i = r;
                            if (F && F.has(i)) {
                                var u = F.get(i);
                                ze.append(u.input, t.index, n, u.raw);
                                return true
                            }
                        }
                        if (n.formatters) {
                            try {
                                r = $.terminal.apply_formatters(r, $.extend(je, {
                                    echo: true
                                }))
                            } catch (e) {
                                y(e, "FORMATTING")
                ...
                ze.append(f, t.index, n, a)
            } catch (e) {
                ze.clear();
                if (is_function(je.exceptionHandler)) {
                    je.exceptionHandler.call(ue, e, "TERMINAL")
                } else {
        ...
        function o(e) {
            ...
            if (!e.update) {
                Ke.resize(ge);
                var t = de.empty().detach()
            }
            try {
                ze.clear();
                unpromise(Pe.render(ue.rows(), function(e) {
                    return e.map(function(e) {
                        return E(e)
                    })
                }), function() {
                ...
                if (is_function(je.exceptionHandler)) {
                    je.exceptionHandler.call(ue, e, "TERMINAL (redraw)")
                } else {
        ...
        function k() {
            if (je.greetings === undefined) {
                ue.echo(ue.signature, {
                    finalize: a11y_hide,
                    formatters: false
                })
            } else if (je.greetings) {
                var e = typeof je.greetings;
                if (e === "string") {
                    ue.echo(je.greetings)
                } else if (e === "function") {
                    ue.echo(function() {
                        try {
                            return je.greetings.call(ue, ue.echo)
                        } catch (e) {
                            je.greetings = null;
                            y(e, "greetings")
                        }
        ...
        function B() {
            return Xe.outerWidth() !== ue.outerWidth()
        }

        function T(e) {
            var t = terminals.get()[e[0]];
            if (!t) {
                throw new $.terminal.Exception(ie().invalidTerminalId)
            }
            var n = e[1];
            if (save_state[n]) {
        ...
        function L(n, e, t) {
            function r() {
                if (je.historyState || je.execHash && t) {
            ...
            function o(e) {
                return is_function(e.done || e.then) && Fe
            }

            function s() {
                var e = l.interpreter.call(ue, n, ue);
                i();
                if (e) {
                    if (!ve) {
                        if (o(e)) {
            ...
            try {
                ...
                if (t) {
                    De = n.trim();
                    pe = $.terminal.split_command(De)
                } else {
                    pe = $.terminal.split_command(n)
                }
                if (!J()) {
                    if (t && (is_function(je.historyFilter) && je.historyFilter(n) || n.match(je.historyFilter))) {
                        Ke.history().append(n)
                    }
                }
                var l = Ue.top();
                ...
                var f = new $.Deferred;
                var c = change_hash;
                if (n.match(/^\s*login\s*$/) && ue.token(true)) {
                    i();
                    if (ue.level() > 1) {
                        ue.logout(true)
                    } else {
                    ...
                    u()
                } else if (je.exit && n.match(/^\s*exit\s*$/) && !Ae) {
                    i();
                    var p = ue.level();
                    if (p === 1 && ue.get_token() || p > 1) {
                        if (ue.get_token(true)) {
                            ue.set_token(undefined, true)
                        }
                        ue.pop()
                    }
                    u()
                } else if (je.clear && n.match(/^\s*clear\s*$/) && !Ae) {
                    i();
                    ue.clear();
                    u()
                } else {
        ...
        function z() {
            var e = ue.prefix_name(true) + "_";
            Ne.remove(e + "token");
            Ne.remove(e + "login")
        }

        function P(e) {
            var t = ue.prefix_name() + "_interpreters";
            var n = Ne.get(t);
            if (n) {
                n = JSON.parse(n)
            } else {
            ...
            if ($.inArray(e, n) === -1) {
                n.push(e);
                Ne.set(t, JSON.stringify(n))
            }
        }

        function N(e) {
            var t = Ue.top();
            var n = ue.prefix_name(true);
            if (!J()) {
                P(n)
            }
            var r = ue.login_name(true);
            Ke.name(n + (r ? "_" + r : ""));
            var i = t.prompt;
            if (is_function(i)) {
                i = at(i)
            ...
            if (typeof t.history !== "undefined") {
                ue.history().toggle(t.history)
            }
            if ($.isPlainObject(t.keymap)) {
                Ke.keymap(null).keymap($.extend({}, st, $.omap(t.keymap, function(e, t) {
                    return function() {
                        var e = [].slice.call(arguments);
                        try {
                            return t.apply(ue, e)
        ...
        function M(t, e, n) {
            ...
            if (r && is_function(r[t]) && !n) {
                try {
                    return r[t].apply(ue, e)
                } catch (e) {
                    delete r[t];
                    y(e, t)
                }
            } else if (is_function(je[t])) {
                try {
                    return je[t].apply(ue, e)
                } catch (e) {
                    je[t] = null;
                    y(e, t)
                }
        ...
        var H = function() {
            function e(e) {
                if (!e) {
                    try {
                        ue.scroll_to(ue.find(".cmd-cursor-line"));
                        return true
                    } catch (e) {
                        return true
                    }
        ...
        function W() {
            var e = ue.find(".cmd-cursor-line");
            return e.is_fully_in_viewport(ue).then(H)
        }
        ...
        function U() {
            if (fire_hash_change && je.execHash) {
                try {
                    if (location.hash) {
        ...
        function K() {
            ...
            var e = false;
            if (is_function(je.onInit)) {
                Be = function() {
                    e = true
                };
                var n;
                try {
                    n = je.onInit.call(ue, ue)
                } catch (e) {
                    y(e, "OnInit")
                } finally {
                    if (!is_promise(n)) {
        ...
        function J() {
            return Ae || Ke.mask() !== false
        }

        function Q(e) {
            var t, n = Ue.top();
            if (is_function(n.keydown)) {
                t = n.keydown.call(ue, e, ue);
                if (t !== undefined) {
                    return t
                }
            } else if (is_function(je.keydown)) {
                t = je.keydown.call(ue, e, ue);
                if (t !== undefined) {
                    return t
                }
            }
        ...
        var Y = {
            ...
            "CTRL+C": function() {
                with_selection(function(e) {
                    if (e === "") {
                        var t = ue.get_command();
                        var n = ue.get_position();
                        t = t.slice(0, n) + "^C" + t.slice(n + 2);
                        A(t);
                        ue.set_command("")
                    } else {
                        var r = ue.find("textarea");
            ...
            TAB: function(e, t) {
                ...
                if (typeof n.caseSensitiveAutocomplete !== "undefined") {
                    ...
                    i = je.caseSensitiveAutocomplete
                }
                if (je.completion && get_type(je.completion) !== "boolean" && n.completion === undefined) {
                    r = je.completion
                } else {
                    r = n.completion
                }
                ...
                function u(e) {
                    e = e.slice();
                    if (!ue.before_cursor(false).match(/\s/)) {
                        if (je.clear && $.inArray("clear", e) === -1) {
                            e.push("clear")
                        }
                        if (je.exit && $.inArray("exit", e) === -1) {
                            e.push("exit")
                        }
                    }
                    ue.complete(e, {
                        echo: true,
                        word: je.wordAutocomplete,
                        escape: je.completionEscape,
                        caseSensitive: i,
                        echoCommand: je.doubleTabEchoCommand,
                        doubleTab: je.doubleTab
                    })
                }
                if (r) {
                    switch (get_type(r)) {
                        case "function":
                            var a = ue.before_cursor(je.wordAutocomplete);
                            if (r.length === 3) {
                                var o = new Error(ie().comletionParameters);
                                y(o, "USER");
                                return false
                            }
                            var s = r.call(ue, a, u);
                        ...
                        case "array":
                            ...
                            break;
                        default:
                            throw new $.terminal.Exception(ie().invalidCompletion)
                    }
                } else {
                    t()
                }
                            ...
                            for (n = requests.length; n--;) {
                                ...
                                if (r.readyState !== 4) {
                                    try {
                                        ...
                                        if (is_function(je.exceptionHandler)) {
                                            je.exceptionHandler.call(ue, t, "AJAX ABORT")
                                        } else {
                                            ue.error(ie().ajaxAbortError)
                                        }
                                    }
                                }
                            }
        ...
        function G(e) {
            var t = Ue.top();
            if (Me && (!We || !je.pauseEvents)) {
                if (is_function(t.keypress)) {
                    return t.keypress.call(ue, e, ue)
                } else if (is_function(je.keypress)) {
                    return je.keypress.call(ue, e, ue)
                }
            }
        }
        ...
        function ie() {
            return $.extend({}, $.terminal.defaults.strings, je && je.strings || {})
        }
        var ue = this;
        if (this.length > 1) {
            return this.each(function() {
        ...
        var ae;
        if (ue.is("body,html")) {
            if (ue.hasClass("full-screen-terminal")) {
                var oe = ue.find("> .terminal").data("terminal");
                if (oe) {
                    return oe
                }
            }
            ae = ue;
            ue = $("<div/>").appendTo("body");
            $("body").addClass("full-screen-terminal")
        } else if (ue.data("terminal")) {
            return ue.data("terminal")
        }
        var se = $.omap({
            id: function() {
                return he
            ...
            export_view: function() {
                ...
                return $.extend({}, {
                    focus: Me,
                    mask: Ke.mask(),
                    prompt: ue.get_prompt(),
                    command: ue.get_command(),
                    position: Ke.position(),
                    lines: clone(Pe.data()),
                    interpreters: Ue.clone(),
                    history: Ke.history().data
                }, e)
            },
            import_view: function(t) {
                if (Ae) {
                    throw new Error(sprintf(ie().notWhileLogin, "import_view"))
                }
                M("onImport", [t]);
                Ee(function e() {
                    ue.set_prompt(t.prompt);
                    ue.set_command(t.command);
                    Ke.position(t.position);
                    Ke.mask(t.mask);
                    if (t.focus) {
                        ue.focus()
                    }
                    Pe.import(clone(t.lines).filter(function(e) {
                        return e[0]
                    }));
            ...
            save_state: function(e, t, n) {
                if (typeof n !== "undefined") {
                    save_state[n] = ue.export_view()
                } else {
                    save_state.push(ue.export_view())
                }
                if (!$.isArray(hash_commands)) {
                    hash_commands = []
                }
                if (e !== undefined && !t) {
                    var r = [he, save_state.length - 1, e];
            ...
            autologin: function(e, t, n) {
                ue.trigger("terminal.autologin", [e, t, n]);
                return ue
            },
            login: function(r, i, u, a) {
                be.push([].slice.call(arguments));
                if (Ae) {
                    throw new Error(sprintf(ie().notWhileLogin, "login"))
                }
                if (!is_function(r)) {
                    throw new Error(ie().loginIsNotAFunction)
                }
                Ae = true;
                if (ue.token() && ue.level() === 1 && !qe) {
                    Ae = false;
                    ue.logout(true)
                } else if (ue.token(true) && ue.login_name(true)) {
                    Ae = false;
                    if (is_function(u)) {
                        u()
                    }
                ...
                function s(e, t, n) {
                    if (t) {
                        ...
                        if (i) {
                            if (!n) {
                                ue.error(ie().wrongPasswordTryAgain)
                            }
                            ue.pop(undefined, true).set_mask(false)
                        } else {
                            Ae = false;
                            if (!n) {
                                ue.error(ie().wrongPassword)
                            }
                            ue.pop(undefined, true).pop(undefined, true)
                        }
                        if (is_function(a)) {
                            a()
                        }
                    ...
                    ue.off("terminal.autologin")
                }
                ue.on("terminal.autologin", function(e, t, n, r) {
                ...
                ue.push(function(n) {
                    ue.set_mask(je.maskChar).push(function(e) {
                        try {
                            ...
                            ue.pause();
                            var t = r.call(ue, n, e, function(e, t) {
                                s(n, e, t)
                            });
                            if (t && is_function(t.then || t.done)) {
            ...
            complete: function(r, i) {
                ...
                var a = ue.before_cursor(i.word).replace(/\\"/g, '"');
                var s = false;
                if (i.word) {
                    if (a.match(/^"/)) {
                        s = '"'
                ...
                if (me % 2 === 0) {
                    ye = ue.before_cursor(i.word)
                } else {
                    var e = ue.before_cursor(i.word);
                    if (e !== ye) {
                        return
                    }
                }
                ...
                function p(e, t) {
                    var n = ue.get_command();
                    var r = ue.get_position();
                    var i = new RegExp("^" + e, "i");
                    var u = n.slice(0, r);
                    var a = n.slice(r);
                    var o = t.replace(i, "") + (s || "");
                    ue.set_command(u + o + a);
                    ue.set_position((u + o).length)
                }
                if (c.length === 1) {
                    if (i.escape) {
                        p(t, c[0])
                    } else {
                        ue.insert(c[0].replace(f, "") + (s || ""))
                    }
                    ye = ue.before_cursor(i.word);
                    return true
                } else if (c.length > 1) {
                    if (++me >= 2) {
                        ...
                        if (i.echo) {
                            if (is_function(i.doubleTab)) {
                                ...
                                var D = i.doubleTab.call(ue, a, c, A);
                                ...
                                ue.echo($.terminal.escape_brackets(m), {
                                    keepWords: true,
                                    formatters: false
                                })
                            }
            ...
            pause: function(t) {
                xe(function e() {
                    Be();
                    We = true;
                    Ke.disable(t || is_android);
                    if (!t) {
                        Ke.find(".cmd-prompt").hidden()
                    }
                    M("onPause")
                });
                return ue
            ...
            resume: function(i) {
                xe(function e() {
                    We = false;
                    if (Me && terminals.front() === ue) {
                        Ke.enable(i)
                    }
                    Ke.find(".cmd-prompt").visible();
                    var t = Re;
                    Re = [];
                    for (var n = 0; n < t.length; ++n) {
                        ue.exec.apply(ue, t[n])
                    }
                    ue.trigger("resume");
                    var r = O.shift();
                    if (r) {
            ...
            geometry: function() {
                var t = window.getComputedStyle(ue[0]);
            ...
            insert: function(n, r) {
                if (typeof n === "string") {
                    Ee(function e() {
                        var t = ue.is_bottom();
                        Ke.insert(n, r);
                        if (je.scrollOnEcho || t) {
                            ue.scroll_to_bottom()
                        }
                    });
                    return ue
                } else {
                    throw new Error(sprintf(ie().notAString, "insert"))
                }
            },
            set_prompt: ne("prompt", function(t) {
                if (is_function(t)) {
                    Ke.prompt(function(e) {
                        return t.call(ue, e, ue)
                    })
                } else {
                    Ke.prompt(t)
                }
            ...
            get_output: function(e) {
                if (e) {
                    ...
                    return Pe.get_snapshot()
                }
            },
            resize: function(e, t) {
                if (!ue.is(":visible")) {
                    ue.stopTime("resize");
                    ue.oneTime(500, "resize", function() {
                        ue.resize(e, t)
                    })
                } else {
                    if (e && t) {
                    ...
                    e = ue.width();
                    t = ue.height();
                    if (typeof je.numChars !== "undefined" || typeof je.numRows !== "undefined") {
                        Ke.resize(je.numChars);
                        ue.refresh();
                        M("onResize");
                        return
                    }
                    var n = get_num_chars(ue, Oe);
                    var r = get_num_rows(ue, Oe);
                    if (n !== ge || r !== _e) {
                        ue.clear_cache();
                        ge = n;
                        _e = r;
            ...
            refresh: function() {
                if (Oe.width !== 0) {
                    ue[0].style.setProperty("--char-width", Oe.width)
                }
                ue.clear_cache();
                if (ye) {
                    Ke.resize()
            ...
            flush: function(g) {
                ...
                Ee(function e() {
                    try {
                        ...
                        var t = ue.is_bottom();
                        var u = je.scrollOnEcho && g.scroll || t;
                        var a;
                        var o = true;
                        var s = false;
                        var l = $();
                        ...
                        if (l.length === 0) {
                            n.css("margin-left", 0);
                            r.css("top", 0);
                            Ke.__set_prompt_margin(0);
                            i = ue.find(".terminal-output div:last-child" + " div:last-child");
                            ...
                            n.css("margin-left", p);
                            r.css("top", -c.height);
                            var D = ue.geometry().char.width;
                            var m = Math.round(p / D);
                            Ke.__set_prompt_margin(m)
                        }
                        x();
                        M("onFlush");
                        var d = ue.find(".cmd-cursor");
                        var h = ue.find(".cmd").offset();
                        var v = ue.offset();
                        setTimeout(function() {
                            css(ue[0], {
                                "--terminal-height": ue.height(),
                                "--terminal-x": h.left - v.left,
                                "--terminal-y": h.top - v.top,
                                "--terminal-scroll": ue.prop("scrollTop")
                            });
                            d.hide();
                            setTimeout(function() {
                                d.show()
                        ...
                        if (is_function(je.exceptionHandler)) {
                            try {
                                je.exceptionHandler.call(ue, e, "TERMINAL (Flush)")
                            } catch (e) {
                                je.exceptionHandler = $.noop;
            ...
            update: function(r, t, i) {
                Ee(function e() {
                    ...
                    if (!Pe.valid_index(r)) {
                        ue.error("Invalid line number " + r)
                    } else if (t === null) {
                        Pe.update(r, null);
                        de.find("[data-index=" + r + "]").remove()
                    } else {
                        t = s(t, {
                            update: true,
                            line: r
                ...
                function t(i) {
                    try {
                        var u = $.extend({
                            ...
                            typing: false,
                            keepWords: false,
                            invokeMethods: je.invokeMethods,
                            onClear: null,
                            formatters: true,
                            allowedAttributes: je.allowedAttributes,
                            newline: true
                        }, r || {});
                        (function(n) {
                        ...
                        if (u.typing) {
                            ...
                            var e = ue.typing("echo", u.delay, i, u);
                            e.then(function() {
                                o.resolve()
                            });
                            return
                        ...
                        unpromise(t, function(e) {
                            ...
                            unpromise(r, function() {
                                ...
                                for (var t = 0; t < e.length; ++t) {
                                    ue.echo.apply(ue, e[t])
                                }
                            })
                        })
                    } catch (e) {
                        if (is_function(je.exceptionHandler)) {
                            je.exceptionHandler.call(ue, e, "TERMINAL (echo)")
                        } else {
            ...
            typing: function(t, e, n, r) {
                ...
                Ee(function e() {
                    if (["prompt", "echo", "enter"].indexOf(t) >= 0) {
                        if (t === "prompt") {
                            Z(n, u)
                        } else if (t === "echo") {
                            ee(n, u)
                        } else if (t === "enter") {
                            with_prompt(ue.get_prompt(), function(e) {
                                te(e, n, u)
                            }, ue)
                        }
                    } else {
            ...
            logout: function(n) {
                if (Ae) {
                    throw new Error(sprintf(ie().notWhileLogin, "logout"))
                }
                Ee(function e() {
                    if (n) {
                        var t = be.pop();
                        ue.set_token(undefined, true);
                        ue.login.apply(ue, t)
                    } else if (Ue.size() === 1 && ue.token()) {
                        ue.logout(true)
                    } else {
                        while (Ue.size() > 1) {
                            if (ue.token()) {
                                ue.logout(true).pop().pop()
                            } else {
                                ue.pop()
                            }
                        }
            ...
            token: function(e) {
                return Ne.get(ue.prefix_name(e) + "_token")
            },
            set_token: function(e, t) {
                var n = ue.prefix_name(t) + "_token";
                if (typeof e === "undefined") {
                    Ne.remove(n)
                } else {
                    Ne.set(n, e)
            ...
            login_name: function(e) {
                return Ne.get(ue.prefix_name(e) + "_login")
            },
            name: function() {
                return Ue.top().name
            },
            prefix_name: function(e) {
                var t = (je.name ? je.name + "_" : "") + he;
                if (e && Ue.size() > 1) {
                    var n = Ue.map(function(e) {
                        return e.name || ""
                    }).slice(1).join("_");
                    if (n) {
                        t += "_" + n
            ...
            read: function(e, t, n) {
                ...
                if (r.typing) {
                    var i = ue.get_prompt();
                    r.typing = false;
                    return ue.typing("prompt", r.delay, e).then(function() {
                        return ue.set_prompt(i).read(e, r)
                    })
                }
                ve = true;
                    ...
                    g(a, o.login, function(e) {
                        ...
                        if (r.completion === true) {
                            if ($.isArray(e.completion)) {
                                Ue.top().completion = e.completion
                        ...
                        if (r.login) {
                            ...
                            if (n === "function") {
                                t = r.infiniteLogin ? $.noop : ue.pop;
                                ue.login(r.login, r.infiniteLogin, u, t)
                            } else if (get_type(a) === "string" && n === "string" || n === "boolean") {
                                t = r.infiniteLogin ? $.noop : ue.pop;
                                ue.login(_(a, r.login), r.infiniteLogin, u, t)
                            }
                        } else {
                            u()
                        }
            ...
            keymap: function(e, n) {
                ...
                if (typeof n === "undefined") {
                    if (typeof e === "string") {
                        ...
                        e = $.extend({}, st, $.omap(e || {}, function(n, r) {
                            if (!st[n]) {
                                return r.bind(ue)
                            }
                            return function(e, t) {
                                return r.call(ue, e, function() {
                                    return st[n](e, t)
                                })
                            }
                        }));
                        Ke.keymap(null).keymap(e)
                    }
                } else if (typeof n === "function") {
                    var r = e;
                    if (!st[r]) {
                        Ke.keymap(r, n.bind(ue))
                    } else {
                        Ke.keymap(r, function(e, t) {
                            return n.call(ue, e, function() {
                                return st[r](e, t)
                            })
                        })
                    }
            ...
            purge: function() {
                Ee(function e() {
                    var t = ue.prefix_name() + "_";
                    var n = Ne.get(t + "interpreters");
                    if (n) {
                        $.each(JSON.parse(n), function(e, t) {
                            Ne.remove(t + "_commands");
                            Ne.remove(t + "_token");
                            Ne.remove(t + "_login")
                        })
                    }
                    Ke.purge();
                    Ne.remove(t + "interpreters")
                });
                return ue
            },
            destroy: function() {
                Ee(function e() {
                    Ke.destroy().remove();
                    ue.resizer("unbind");
                    ue.touch_scroll("unbind");
                    Ge.resizer("unbind").remove();
                    $(document).unbind(".terminal_" + ue.id());
                    $(window).unbind(".terminal_" + ue.id());
                    ue.unbind("click wheel mousewheel mousedown mouseup");
                    ue.removeData("terminal").removeClass("terminal").unbind(".terminal");
                    if (je.width) {
                        ue.css("width", "")
                    }
                    if (je.height) {
                    ...
                    $(window).off("blur", it).off("focus", rt);
                    ue.find(".terminal-fill, .terminal-font").remove();
                    ue.stopTime();
                    terminals.remove(he);
                    if (Qe) {
                        if (Qe.unobserve) {
                    ...
                    var t = ue.find(".terminal-scroll-marker");
                    if (ke) {
                        ke.unobserve(t[0])
                    }
                    t.remove();
                    ...
                    if (is_mobile) {
                        ue.off(["touchstart.terminal", "touchmove.terminal", "touchend.terminal"].join(" "))
                    }
                    de.remove();
                    Ve.remove();
                    if (ae) {
            ...
            scroll_to: function(e) {
                var t = ue.scrollTop() - ue.offset().top + $(e).offset().top;
                ue.scrollTop(t);
                return ue
            },
            scroll_to_bottom: function() {
                var e;
                if (ue.prop) {
                    e = ue.prop("scrollHeight")
                } else {
                    e = ue.attr("scrollHeight")
                }
                ue.scrollTop(e);
                return ue
            },
            is_bottom: function() {
                if (je.scrollBottomOffset === -1) {
                    return false
            ...
            return function() {
                if (Ie) {
                    if (!je.exceptionHandler) {
                        throw new $.terminal.Exception(ie().defunctTerminal)
                    }
                }
                try {
                    return e.apply(ue, [].slice.apply(arguments))
                } catch (e) {
                    if (t !== "exec" && t !== "resume") {
        ...
        $.extend(ue, se);
        if (ue.length === 0) {
            var le = sprintf(ie().invalidSelector);
            throw new $.terminal.Exception(le)
        }
        ue.data("terminal", ue);
        var fe = [];
        var ce = false;
        ...
        var me = 0;
        var de;
        var he = terminals.length();
        var ve = false;
        var ge;
        var _e;
        var ye;
        var be = new Stack;
        var Ce = new DelayQueue;
        var Fe = false;
        var we = new DelayQueue;
        var Ee = re(we);
        var xe = re(Ce);
        var $e;
        var ke;
        ...
        var Te, Se;
        var Re = [];
        var je = $.extend({}, $.terminal.defaults, {
            name: ue.selector,
            exit: !!(t && t.login || !t)
        }, t || {});
        if (typeof je.width === "number") {
            ue.width(je.width)
        }
        if (typeof je.height === "number") {
            ue.height(je.height)
        }
        var Oe = get_char_size(ue);
        var Le = !terminal_ready(ue);
        delete je.formatters;
        var Ie = false;
        var ze = new FormatBuffer(function(e) {
            return {
                linksNoReferrer: je.linksNoReferrer,
                linksNoFollow: je.linksNoFollow,
                anyLinks: je.anyLinks,
                charWidth: Oe.width,
                useCache: je.useCache,
                escape: false,
                allowedAttributes: e.allowedAttributes || []
            }
        });
        var Pe = new OutputLines(function() {
            return je
        });
        var Ne = new n(je.memory);
        var Me = je.enabled;
        var He = false;
        var We = false;
        var qe = true;
        ...
        var Qe;
        var Ye;
        if (je.ignoreSystemDescribe === true) {
            je.describe = false
        }
        $(document).bind("ajaxSend.terminal_" + ue.id(), function(e, t) {
            requests.push(t)
        });
        var Ve = $('<div class="terminal-wrapper"/>').appendTo(ue);
        $(broken_image).hide().appendTo(Ve);
        var Ge = $('<div class="terminal-font">&nbsp;</div>').appendTo(ue);
        var Xe = $('<div class="terminal-fill"/>').appendTo(ue);
        de = $("<div>").addClass("terminal-output").attr("role", "log").appendTo(Ve);
        ue.addClass("terminal");
        if (je.login && M("onBeforeLogin") === false) {
            qe = false
        }
        var Ze;
        if (typeof e === "string") {
            ...
            for (var et = 0, tt = e.length; et < tt; ++et) {
                if (typeof e[et] === "string") {
                    Ze = e[et];
                    break
                }
            }
        ...
        var nt;
        if (is_function(je.login)) {
            nt = je.login
        } else if (Ze && (typeof je.login === "string" || je.login === true)) {
            nt = _(Ze, je.login)
        }
        terminals.append(ue);
        ...
        function it() {
            Je = Me;
            ue.disable().find(".cmd textarea").trigger("blur", [true])
        }
        ...
        function ut(e) {
            ...
            if (get_type(e) !== "string") {
                if (is_function(je.parseObject)) {
                    var t = je.parseObject(e);
                    if (get_type(t) === "string") {
                        e = t
                    }
                } else if (is_array(e)) {
                    e = $.terminal.columns(e, ue.cols(), je.tabs)
                } else {
                    e = String(e)
                }
            }
        ...
        $(document).on("paste.terminal_" + ue.id(), ot);
        var st = $.extend({}, Y, $.omap(je.keymap || {}, function(n, r) {
            if (!Y[n]) {
                return r.bind(ue)
            }
            return function(e, t) {
        ...
        g(e, je.login, function(e) {
            if (je.completion && typeof je.completion !== "boolean" || !je.completion) {
            ...
            Ue = new Stack($.extend({}, je.extra, {
                name: je.name,
                prompt: t,
                keypress: je.keypress,
                keydown: je.keydown,
                resize: je.onResize,
                greetings: je.greetings,
                mousewheel: je.mousewheel,
                history: je.history,
                keymap: st
            }, e));
            Ke = $("<div/>").appendTo(Ve).cmd({
                tabindex: je.tabindex,
                mobileDelete: je.mobileDelete,
                mobileIngoreAutoSpace: je.mobileIngoreAutoSpace,
                prompt: nt ? false : t,
                history: je.memory ? "memory" : je.history,
                historyFilter: je.historyFilter,
                historySize: je.historySize,
                caseSensitiveSearch: je.caseSensitiveSearch,
                onPaste: je.onPaste,
                width: "100%",
                enabled: false,
                charWidth: Oe.width,
                keydown: V,
                keymap: st,
                clickTimeout: je.clickTimeout,
                holdTimeout: je.holdTimeout,
                holdRepeatTimeout: je.holdRepeatTimeout,
                repeatTimeoutKeys: je.repeatTimeoutKeys,
                allowedAttributes: je.allowedAttributes,
                keypress: G,
                tabs: je.tabs,
            ...
            function n(e) {
                ...
                if (e) {
                    ...
                    if (!$(t).closest(".terminal").length && ue.enabled()) {
                        ue.disable()
                    }
                }
            }
            ue.oneTime(100, function() {
                $(document).bind("click.terminal_" + ue.id(), n).bind("contextmenu.terminal_" + ue.id(), n)
            });
            var r = $(window);
            ...
            if (is_mobile) {
                (function() {
                    ...
                    ue.on("touchstart.terminal", function(e) {
                        e = e.originalEvent;
                        window.touch_event = e;
                        if (e.target.tagName.toLowerCase() === "a") {
                            return
                        }
                        if (!He && e.touches.length === 1) {
                            n = ue.enabled();
                            var t = e.touches[0];
                            i = {
                                x: t.clientX,
                ...
                r.on("focus.terminal_" + ue.id(), rt).on("blur.terminal_" + ue.id(), it);
                var h;
                (function() {
                    var t = 0;
                    var n;
                    var r = "click_" + ue.id();
                    var i = ue.find(".cmd textarea");

                    function u() {
                        if (n.is(".terminal") || n.is(".terminal-wrapper")) {
                            var e = ue.get_command().length;
                            ue.set_position(e)
                    ...
                    ue.mousedown(function(e) {
                        if (!scrollbar_event(e, Xe)) {
                            n = $(e.target)
                        }
                    }).mouseup(function() {
                        if (h) {
                ...
                (function() {
                    ...
                    ue.on(e, function(e) {
                        ...
                        if (h) {
                            ...
                            var n = Ke.offset();
                            var r = Ke[0].getBoundingClientRect();
                            var i = ue.offset();
                            var u = i.top - n.top;
                            ...
                            var s = 4 * 14;
                            var l = 5 * 14;
                            var f = ue[0].getBoundingClientRect();
                            var c = Xe.outerWidth();
                            var p = a + r.top + s;
                            p = p - f.height - f.top;
                            var D = o + r.left + l;
                            ...
                            ue.stopTime("textarea");
                            ue.oneTime(100, "textarea", function() {
                                var e = {
                                    left: "",
                                    top: "",
                                    width: "",
                                ...
                                if (!is_css_variables_supported) {
                                    var t = ue.find(".cmd .cmd-cursor-line").prevUntil(".cmd-prompt").length;
                                    e.top = t * 14 + "px"
                                }
                                m.css(e)
                            });
                            ue.stopTime("selection");
                            ue.everyTime(20, "selection", function() {
                                if (m[0].selection !== m[0].value) {
                                    if (get_textarea_selection(m[0])) {
                                        clear_textarea_selection(m[0]);
                                        select(ue.find(".terminal-output")[0], ue.find(".cmd div:last-of-type")[0]);
                                        ue.stopTime("selection")
                                    }
                                }
                            })
                ...
                ue.on("scroll", function() {
                    var e = ue.find("textarea");
                    var t = ue[0].getBoundingClientRect();
                    var n = ue[0].scrollHeight;
                    var r = ue.scrollTop();
                    var i = n - (r + t.height);
                    if (i === 0) {
                        e.css("top", "")
            ...
            function i() {
                ...
                Oe = get_char_size(ue);
                if (e !== Oe.width) {
                    Ke.option("charWidth", Oe.width).refresh()
                }
            }
            u();
            ...
            function a() {
                ...
                ue.resizer("unbind").resizer(u, e);
                Ge.resizer("unbind").resizer(function() {
                    i();
                    ue.resize()
                }, e)
            }
            ...
            function o(e) {
                $e = e[0].intersectionRatio === 1
            }

            function s() {
                if (window.IntersectionObserver) {
                    var e = $('<div class="terminal-scroll-marker"/>').appendTo(ue);
                    var t = e;
                    if (je.scrollBottomOffset !== -1) {
                        t = $("<div/>").css({
                            height: je.scrollBottomOffset
                        }).appendTo(e)
                    }
                    ke = new IntersectionObserver(o, {
                        root: ue[0]
                    });
                    ke.observe(t[0])
                }
            ...
            function l() {
                ...
                function n() {
                    if (ue.is(":visible") && !t) {
                        ...
                        Ve.css("visibility", "")
                    } else if (t && !ue.is(":visible")) {
                        t = false;
                        e = $.terminal.active() === ue && ue.enabled();
                        ue.disable();
                        Ve.css("visibility", "hidden")
                    }
                }
                if (window.IntersectionObserver && ue.css("position") !== "fixed") {
                    Qe = new IntersectionObserver(n, {
                        root: null
                    });
                    Qe.observe(ue[0])
                } else {
                    Qe = setInterval(n, 100)
                }
            }
            var f = !!ue.closest("body").length;
            var c = window.MutationObserver || window.WebKitMutationObserver;
            if (c) {
                Ye = new c(function() {
                    if (ue.closest("body").length) {
                        if (!f) {
                            ue.scroll_to_bottom();
                            l();
                            u()
            ...
            Ce.resolve();
            if (Me && ue.is(":visible") && !is_mobile) {
                ue.focus(undefined, true)
            } else {
                ue.disable()
            }
            if (is_function(nt)) {
            ...
            if (je.execHash) {
                ...
                var i = false;
                $(document).bind("keydown.terminal_" + ue.id(), function(e) {
                    if (e.shiftKey) {
                        i = true
                    }
                }).bind("keyup.terminal_" + ue.id(), function(e) {
                ...
                function n(e, t) {
                    if (!i) {
                        ...
                        if (is_function(n.mousewheel)) {
                            r = n.mousewheel(e, t, ue)
                        } else if (is_function(je.mousewheel)) {
                            r = je.mousewheel(e, t, ue)
                        }
                        if (r === true) {
                            return
                        }
                ...
                ue.touch_scroll(function(e) {
                    var t = e.current.clientY - e.previous.clientY;
                    var n;
                    var r = Ue.top();
                    if (is_function(r.touchscroll)) {
                        n = r.touchscroll(e, t, ue)
                    } else if (is_function(je.touchscroll)) {
                        n = je.touchscroll(e, t, ue)
                    }
                    css(ue[0], {
                        "--terminal-scroll": ue.prop("scrollTop")
                    });
